...
<template>
  <view class="content">
    ...
    <k-radio value="1">选项1</k-radio>
    <k-radio value="1">选项2</k-radio>
    ...
    <k-checkbox-group>
      <k-label v-for="(item, index) in checkboxItems" :key="index">
        <k-list-cell>
          <view class="k-list__cell">
            <text>{{ item.name }}</text>
            <k-checkbox :checked="item.checked" :value="item.value" :disabled="item.disabled">
            </k-checkbox>
          </view>
        </k-list-cell>
      </k-label>
...
const actionSheetRadioValue = ref(null)
